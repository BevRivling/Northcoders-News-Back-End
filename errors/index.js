...
exports.handle405s = (req, res, next) => {
  res
    .status(405)
    .send({ msg: "Bad Request: method not available for this endpoint" });
};

exports.handle422s = (err, req, res, next) => {
  const codesRef422 = {
    23505: "Bad Request: please insert a unique slug",
    422: "Bad Request, Mate: please insert a unique slug m8"
  };
